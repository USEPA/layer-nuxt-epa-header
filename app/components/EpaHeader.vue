...
<template>
  <div>
    <div
      class="skiplinks"
      role="navigation"
      aria-labelledby="skip-to-main--6616f33119786"
    >
      <a
        id="skip-to-main"
        href="#main"
        class="skiplinks-link visually-hidden focusable"
          ...
          <div class="l-header__branding">
            ...
            >
              <svg
                ...
                aria-hidden="true"
              ><use href="https://www.epa.gov/themes/epa_theme/images/sprite.artifact.svg#magnifying-glass" /></svg>          
              <svg
                class="icon l-header__search-button-icon-close"
                aria-hidden="true"
              ><use href="https://www.epa.gov/themes/epa_theme/images/sprite.artifact.svg#xmark" /></svg>
            </button>
            <a
              class="site-logo"
              ...
              <div role="search">
                ...
                >
                  ...
                  <svg
                    ...
                    aria-hidden="true"
                  ><use href="https://www.epa.gov/themes/epa_theme/images/sprite.artifact.svg#magnifying-glass" /></svg>      <span class="usa-search__submit-text">Search</span>
                </button>
                <input
                  type="hidden"
                  name="areaname"
          ...
          <div class="usa-nav__inner">
            ...
            >
              <svg
                ...
                aria-hidden="true"
                role="img"
              ><title>Primary navigation</title><use href="https://www.epa.gov/themes/epa_theme/images/sprite.artifact.svg#xmark" /></svg>
            </button>
